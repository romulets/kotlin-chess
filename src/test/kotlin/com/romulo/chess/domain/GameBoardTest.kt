...
class GameBoardTest {
    ...
    fun testInitialState() {
        ...
        assertPieceIs(gameBoard,
            position(1, 'a'), Rook::class, WHITE)
        assertPieceIs(gameBoard,
            position(1, 'b'), Knight::class, WHITE)
        assertPieceIs(gameBoard,
            position(1, 'c'), Bishop::class, WHITE)
        assertPieceIs(gameBoard,
            position(1, 'd'), Queen::class, WHITE)
        assertPieceIs(gameBoard,
            position(1, 'e'), King::class, WHITE)
        assertPieceIs(gameBoard,
            position(1, 'f'), Bishop::class, WHITE)
        assertPieceIs(gameBoard,
            position(1, 'g'), Knight::class, WHITE)
        assertPieceIs(gameBoard,
            position(1, 'h'), Rook::class, WHITE)
        ...
        assertPieceIs(gameBoard,
            position(8, 'a'), Rook::class, BLACK)
        assertPieceIs(gameBoard,
            position(8, 'b'), Knight::class, BLACK)
        assertPieceIs(gameBoard,
            position(8, 'c'), Bishop::class, BLACK)
        assertPieceIs(gameBoard,
            position(8, 'd'), King::class, BLACK)
        assertPieceIs(gameBoard,
            position(8, 'e'), Queen::class, BLACK)
        assertPieceIs(gameBoard,
            position(8, 'f'), Bishop::class, BLACK)
        assertPieceIs(gameBoard,
            position(8, 'g'), Knight::class, BLACK)
        assertPieceIs(gameBoard,
            position(8, 'h'), Rook::class, BLACK)
